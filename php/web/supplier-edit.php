...
<section class="bg-gray-100 dark:bg-neutral-800 p-10 rounded-lg">
  ...
  <form action="supplier-update.php" method="post">
    <div class=" flex gap-3">
      ...
      <input type="text" name="contact" value="<?= $row['contact'] ?>" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
